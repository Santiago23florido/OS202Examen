...
\input{sections/01_environnement}
\input{sections/02_preliminaires.tex}
\input{sections/03_numba.tex}
\input{sections/04_separation.tex}
\input{sections/05_subdomain.tex}
\input{sections/06_barnes_hut.tex}
\end{document}